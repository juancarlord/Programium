	...
	<div class="features-boxed">
        <div class="container carousel">
            <div class="intro" style="margin-top: 100px;">
                <h2 class="text-center">Conceptos básicos de la programación</h2>
                <p class="text-center">Conceptos básicos que debes saber para ser un buen programador.</p>
            </div>
			  ...
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      ...
			      <div class="carousel-caption">
			      	<h5>Importancia de la programación</h5>
			      </div>
			      </a>
			    </div>
			    ...
			    <div class="carousel-item">
			      ...
			      <div class="carousel-caption">
			      	<h5>Software para DFD y Pseudocódigo</h5>
			      </div>
			      </a>
			    </div>
			    <div class="carousel-item">
