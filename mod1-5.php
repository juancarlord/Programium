	...
	<div class="features-boxed">
        <div class="container carousel">
            <div class="intro" style="margin-top: 100px;">
                <h2 class="text-center">Arreglos de tamaño fijo</h2>
                <p class="text-center">Explicá el funcionamiento de los arreglos de tamaño fijo.</p>
            </div>
			  ...
			  <div class="carousel-inner">
			    ...
			    <div class="carousel-item">
			      ...
			      <div class="carousel-caption">
			      	<h5>Arreglos de tres o más dimensiones</h5>
			      </div>
			      </a>
			    </div>			    
			  </div>
