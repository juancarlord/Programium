            ...
            <div class="row justify-content-center features">
                ...
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box" style="height:312px;"><i class="fa fa-signal icon"></i>
                        ...
                        <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu.</p><a href="mod3-3.php" class="learn-more">Ingresa »</a>                
                    </div>
                </div>                                
            </div>
        </div>
