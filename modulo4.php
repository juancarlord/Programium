            ...
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="icon ion-android-desktop icon"></i>
                        ...
                        <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu.</p><a href="mod4-1.php" class="learn-more">Ingresa »</a>                
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box" style="height:313px;"><i class="icon-mouse icon"></i>
                        <h3 class="name" style="margin-top:26px;">Backend</h3>
                        <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu.</p><a href="mod4-2.php" class="learn-more">Ingresa »</a>                
                    </div>
                </div>                
            </div>
        </div>
